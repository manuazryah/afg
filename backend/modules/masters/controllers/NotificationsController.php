...
class NotificationsController extends Controller {
    ...
    public function actionCreate() {
        ...
        if ($model->load(Yii::$app->request->post()) && Yii::$app->SetValues->Attributes($model)) {
            $expiry_date = Yii::$app->request->post()['Notifications']['expire_date'];
            $model->expire_date = date("Y-m-d", strtotime($expiry_date));
            if ($model->validate() && $model->save()) {
                Yii::$app->session->setFlash('success', "New Notification added Successfully");
