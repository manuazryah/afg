                            ...
                            <div class="row">
                                <div class="col-md-6" style="margin-top: 20px">
                                    <div class="picas1" style="width: 100%;height: 140px;margin-bottom: 10px;border: 1px solid #000;">
                                        <span class="lefti" style="width: 39%;float: left"><img src="<?= 'http://' . Yii::$app->request->serverName  ?>/AFG/img/vhehicle-front.jpg" style="height: 120px;margin-left: 2px;margin-top: 2px;"></span>										
                                ...
                                <div class="col-md-6" style="margin-top: 20px">
                                    <div class="picas2" style="width: 100%;height: 140px;margin-bottom: 10px;border: 1px solid #000;">
                                        <span class="lefti" style="width: 39%;float: left"><img src="<?= 'http://' . Yii::$app->request->serverName  ?>/AFG/img/vehicle-back.jpg" style="height: 120px;margin-left: 2px;margin-top: 2px;"></span>										
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="picas3" style="border: 1px solid #000;border-left-width: 1px;border-right-style: solid;border-bottom-style: solid;border-left-style: solid;border-left-color: #000;">
                                        <div class="">
                                            <img src="<?= 'http://' . Yii::$app->request->serverName ?>/AFG/img/vehicle-driverside.jpg" width="384" height="141" style="margin-left: 2px;margin-top: 2px;margin-bottom: 2px;"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="picas3" style="border: 1px solid #000;border-left-width: 1px;border-right-style: solid;border-bottom-style: solid;border-left-style: solid;border-left-color: #000;">
                                        <div class="">
                                            <img src="<?= 'http://' . Yii::$app->request->serverName  ?>/AFG/admin/img/vehicle-passengerside.jpg" width="384" height="141" style="margin-left: 2px;margin-top: 2px;margin-bottom: 2px;"></div>
                        ...
                        <div class="pics">
                            ...
                            if (count(glob("{$path}/*")) > 0) {
                                ...
                                foreach (glob("{$path}/*") as $file) {
                                    ...
                                    if ($img_nmees['1'] != '') {
                                        ?>
                                        <img width="230px" height="230px" src="<?= 'http://' . Yii::$app->request->serverName . '/AFG/uploads/vehicle/' . $model->id . '/' . end($arry) ?>" style="margin-left: 20px;">
                                            <?php
                                        }
                                        if ($k % 4 == 0) {
                                            ?>
