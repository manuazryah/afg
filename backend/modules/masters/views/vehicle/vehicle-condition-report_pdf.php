            ...
            <div class="basic_info">
                <div class="row">
                        ...
                        <div class="part1">
                            <table width="100%" style="margin-bottom:4px">
                                <tbody><tr>
                                        ...
                                        <td width="82%" class="line_under" id="CUSTOMER NAME" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;">MASSOUD AHMAD HAJI NOOR AHMAD</td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table width="100%" style="margin-bottom:4px">
                                <tbody><tr>
                                        ...
                                        <td width="72%" class="line_under" id="Address L1" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;">NY</td>
                            ...
                            <table width="100%" style="margin-bottom:4px">
                                <tbody><tr>
                                        ...
                                        <td width="44%" class="line_under" id="Phone Number" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;">310-593-9604	</td>
                                        <td width="14%" style="font-size: 1em;"><b>Weight</b></td>
                                        <td width="24%" class="line_under" id="Weight" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;"></td>  
                                    </tr>
                                </tbody></table>
                            ...
                            <table width="100%" style="margin-bottom:4px">
                                <tbody><tr>
                                        ...
                                        <td width="44%" class="line_under" id="Lot Number" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;">23488361	</td>
                            ...
                            <table width="100%" style="margin-bottom:4px">
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="24%" class="line_under" id="Condition" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;">Non Operable</td>
                                        <td width="6%" style="font-size: 1em;"><b>Damaged</b></td>
                                        <td width="24%" class="line_under" id="Damages" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;">Yes</td>  
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="part2">
                            <table width="100%" style="margin-bottom:4px">
                                <tbody><tr>
                                        ...
                                        <td width="38%" class="line_under" id="Year" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;">2012</td>
                                        <td width="11%" style="font-size: 1em;"><b>Color</b></td>
                                        <td width="33%" class="line_under" id="Color" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;"></td>  
                                    </tr>
                                </tbody></table>
                            ...
                            <table width="100%" style="margin-bottom:4px">
                                <tbody><tr>
                                        ...
                                        <td width="38%" class="line_under" id="Model" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;">SONATA</td>
                                        <td width="11%" style="font-size: 1em;"><b>Make</b></td>
                                        <td width="33%" class="line_under" id="Make" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;">HYUNDAI</td>  
                                    </tr>
                                </tbody></table>
                            ...
                            <table width="100%" style="margin-bottom:4px">
                                <tbody><tr>
                                        ...
                                        <td width="82%" class="line_under" id="VIN" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;">5NPEB4AC6CH474705</td>
                                    </tr>
                                </tbody></table>
                            ...
                            <table width="100%" style="margin-bottom:4px">
                                <tbody><tr>
                                        ...
                                        <td width="82%" class="line_under" id="License Number" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;">350306&nbsp;</td>
                                    </tr>
                                </tbody></table>
                            ...
                            <table width="100%" style="margin-bottom:4px">
                                <tbody><tr>
                                        ...
                                        <td width="70%" class="line_under" id="Towed From" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;">Altoona, PA</td>
                                    </tr>
                                </tbody></table>
                            ...
                            <table width="100%" style="margin-bottom:4px">
                                <tbody><tr>
                                        ...
                                        <td width="31%" class="line_under" id="Tow Amount" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;"></td>
                                        <td width="20%" style="font-size: 1em;"><b>Storage Amount</b></td>
                                        <td width="14%" class="line_under" id="Storage" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;"></td>  
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <table width="100%" style="margin-bottom:4px">
                            <tbody><tr>
                                    <td width="6%" style="font-size: 1em;"><b>Towed </b></td><td width="12%" class="line_under" id="Damages" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;">No</td>  
                                    <td width="21%" style="font-size: 1em;"><b>Title Provided</b></td><td width="11%" class="line_under" id="Damages" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;">No</td>  
                                    <td width="6%" style="font-size: 1em;"><b>Pictures</b></td><td width="24%" class="line_under" id="Damages" style="font-size: 1em;border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #000;">No</td>  
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="checklist" style="width: 99%;float: left;margin-top: 15px;border: 1px solid #000;margin-left: 3px;">
                    ...
                    <table width="100%" style="margin-bottom:4px">
                        <tbody>
                            ...
                            <tr>
                                <td><input disabled="true" name="Keys" type="checkbox">Keys</td>

                                <td><input disabled="true" name="Keys" type="checkbox">CD Changer</td>

                                <td><input disabled="true" name="Keys" type="checkbox">GPS Navigation System</td>

                                <td><input disabled="true" name="Keys" type="checkbox">Spare Tire/Jack</td>

                                <td><input disabled="true" name="Keys" type="checkbox">Wheel Covers</td>

                                <td><input disabled="true" name="Keys" type="checkbox">Radio</td>

                            </tr>
                            <tr>
                                <td><input disabled="true" name="Keys" type="checkbox">CD Player</td>
                                <td><input disabled="true" name="Keys" type="checkbox">Mirror</td>

                                <td><input disabled="true" name="Keys" type="checkbox">Speaker</td>

                                <td><input disabled="true" name="Keys" type="checkbox">Other...</td>
                ...
                <div class="row">
                    <div class="col-md-6" style="margin-top: 20px">
                        <div class="picas1" style="width: 100%;height: 140px;margin-bottom: 10px;border: 1px solid #000;">
                            <span class="lefti" style="width: 39%;float: left"><img src="http://manage.awwshipping.com/uploads/Car - Front.jpg" style="height: 120px;margin-left: 2px;margin-top: 2px;"></span>										
                    ...
                    <div class="col-md-6" style="margin-top: 20px">
                        <div class="picas2" style="width: 100%;height: 140px;margin-bottom: 10px;border: 1px solid #000;">
                            <span class="lefti" style="width: 39%;float: left"><img src="http://manage.awwshipping.com/uploads/Car - Back.jpg" style="height: 120px;margin-left: 2px;margin-top: 2px;"></span>										
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="picas3" style="border: 1px solid #000;border-left-width: 1px;border-right-style: solid;border-bottom-style: solid;border-left-style: solid;border-left-color: #000;">
                            <div class="">
                                <img src="http://manage.awwshipping.com/uploads/driver.jpg" width="384" height="141" style="margin-left: 2px;margin-top: 2px;margin-bottom: 2px;"></div>
                    ...
                    <div class="col-md-6">
                        <div class="picas3" style="border: 1px solid #000;border-left-width: 1px;border-right-style: solid;border-bottom-style: solid;border-left-style: solid;border-left-color: #000;">
                            <div class="">
                                <img src="http://manage.awwshipping.com/uploads/Passenger.jpg" width="384" height="141" style="margin-left: 2px;margin-top: 2px;margin-bottom: 2px;"></div>
