        ...
        <div class="mail-body">
            <div class="content" style="margin: 0px 15%;border: 1px solid #d4d1d1;">
                <div class="login-logo" style="text-align: center;font-weight: 600;">
                    <h1><span style="color: #3ec1d5;">AFG</span>Shipping</h1>
                </div>
                <div class="content-detail" style="padding: 0px 10%;">
                    <h2>Reset Your Password</h2>
                    <p>Hi <?= $model->name ?>,</p>
                    <p>You are requested to reset your password for your AFG Shipping  Admin Panel Login. Click the below button to reset it</p>
