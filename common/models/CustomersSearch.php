...
class CustomersSearch extends Customers
{
    ...
    public function rules()
    {
        return [
            ...
            [['customer_id', 'name', 'email', 'phone_usa', 'trn_usa', 'address1', 'country', 'state', 'other_emails', 'upload_documents', 'company_name', 'phone_uae', 'trn_uae', 'address2', 'city', 'zipcode', 'fax', 'notes', 'created_at', 'DOC', 'DOU'], 'safe'],
        ];
    }
