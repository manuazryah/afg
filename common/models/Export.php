...
class Export extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['export_date', 'loding_date', 'ETA', 'cut_off', 'date', 'auto_recieving_date', 'auto_cut_off', 'vessel_cut_off', 'sale_date', 'exporter_dob', 'ultimate_consignee_dob', 'DOC', 'DOU', 'vehicle_id', 'container_images', 'oti_no', 'titles'], 'safe'],
            [['customer', 'broker_name'], 'string', 'max' => 80],
            [['invoice'], 'file', 'extensions' => 'jpg,png,jpeg,pdf'],
            [['titles'], 'file', 'extensions' => 'pdf'],
    ...
    public function attributeLabels() {
        return [
            ...
            'forwading_agent' => 'Forwarding Agent',
