...
/**
 * VehiceCheckOptionsSearch represents the model behind the search form about `common\models\VehiceCheckOptions`.
 */
class VehiceCheckOptionsSearch extends VehiceCheckOptions
{
    /**
     * @inheritdoc
     */
