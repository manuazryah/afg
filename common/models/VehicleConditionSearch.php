...
/**
 * VehicleConditionSearch represents the model behind the search form about `common\models\VehicleCondition`.
 */
class VehicleConditionSearch extends VehicleCondition
{
    /**
     * @inheritdoc
     */
