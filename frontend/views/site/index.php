                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="slider-content">
                            ...
                            <div class="layer-1-1 hidden-xs wow slideInDown" data-wow-duration="2s" data-wow-delay=".2s">
                                <h2 class="title1">Lorem Ipsum has been the industry's standard dummy </h2>
                            </div>
                            <!-- layer 2 -->
                            <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                <h1 class="title2">There are many variations of passages of Lorem Ipsum available</h1>
                            </div>
                            <!-- layer 3 -->
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="slider-content text-center">
                            ...
                            <div class="layer-1-1 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                                <h2 class="title1">There are many variations of passages of Lorem Ipsum available</h2>
                            </div>
                            <!-- layer 2 -->
                            <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                <h1 class="title2">There are many variations of passages of Lorem Ipsum available</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="well-middle">
                    <div class="single-well">
                        <a href="#">
                            <h4 class="sec-head">Test Title</h4>
                        </a>
                        <p>
                        ...
                        <ul>
                            <li>
                                <i class="fa fa-check"></i> Neque porro quisquam
                            </li>
                            <li>
                                <i class="fa fa-check"></i> Neque porro quisquam
                            </li>
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3 text-center">
                        <div class="single-skill">
                            <div class="progress-circular">
                                ...
                                <h3 class="progress-h4">Lorem Ipsum</h3>
                            </div>
                        </div>
                    </div>
                    <!-- single-skill end -->
...
<div class="reviews-area hidden-xs">
    <div class="work-us">
        ...
        <div class="work-right-text text-center">
            ...
            <h5>Lorem IpsumLorem IpsumLorem IpsumLorem IpsumLorem Ipsum.</h5>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="awesome-menu ">
                        <ul class="project-menu">
                            ...
                            <li>
                                <a href="#" data-filter=".development">Lorem Ipsum</a>
                            </li>
                            <li>
                                <a href="#" data-filter=".design">Lorem Ipsum</a>
                            </li>
                            <li>
                                <a href="#" data-filter=".photo">Lorem Ipsum</a>
                            </li>
                        </ul>
                    </div>
                </div>
